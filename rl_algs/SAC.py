...
class Args(RL_Args):
    ...
    """If True, use exp_name directly; if False, use SAC/{env_id}__{exp_name} format"""
...
def train(kwargs: Namespace) -> None:
    ...
    if args.use_simple_exp_name and args.exp_name:
        ...
        # Use default format: SAC/{env_id}__{exp_name}
    ...
    for global_step in tqdm(range(args.total_timesteps), desc="SAC Training", unit="step"):
        ...
        # Handle episode completion (same logic as PPO for gymnasium compatibility)
        episode_done = False
